...
classdef SignalCharacterizationApp < handle
    ...
    methods
        ...
        function buildUI(app)
            ...
            headerH = 60;  % Match Main window header height
            main = uigridlayout(app.UIFig, [7, 1], ...
                'RowHeight', {headerH, 48, 215, 44, '1x', 44, 22}, ...
                'Padding', [0 14 0 0], 'RowSpacing', 16);
            % Padding [left bottom right top] = no top/right gap so header is edge-to-edge like Main

            % --- Header: full-width bar like home page (no space to top or right) ---
            ...
            app.ExportBtn = uibutton(main, 'push', ...
                ...
                'Enable', 'off');
            uihyperlink(main, 'Text', '© Copyrights by Alejandro Suarez, Ph.D.', ...
