...
classdef ProcessingLDFApp < handle
    ...
    methods
        ...
        %% buildUI - Figure, toolbar, axes (Stim/LDF), defined footer (no overlap)
        function buildUI(app)
            ...
            % --- Footer panel (defined section, copyright never overlaps content) ---
            ...
            % --- Toolbar row (below top, above axes) ---
            app.LoadBtn = uicontrol(app.UIFig, 'Style','pushbutton', 'String','Load File', ...
                'Units', 'normalized', 'Position', [0.02 0.92 0.10 0.055], ...
                'Callback', @(~,~)app.loadData());
            uicontrol(app.UIFig, 'Style','pushbutton','String','Set Processing', ...
                'Units', 'normalized', 'Position', [0.13 0.92 0.10 0.055], ...
            ...
            uicontrol(app.UIFig, 'Style','pushbutton','String','Segment by Onsets', ...
                'Units', 'normalized', 'Position', [0.24 0.92 0.10 0.055], ...
            ...
            uicontrol(app.UIFig, 'Style','pushbutton','String','Plot Average LDF', ...
                'Units', 'normalized', 'Position', [0.35 0.92 0.10 0.055], ...
            ...
            app.SaveBtn = uicontrol(app.UIFig, 'Style','pushbutton', 'String','Save Result', ...
                'Units', 'normalized', 'Position', [0.46 0.92 0.10 0.055], ...
                'Callback', @(~,~)opensaveData());
            ...
            uicontrol(app.UIFig, 'Style','text', 'String','Sampling Rate (Hz):', ...
                'Units', 'normalized', 'Position', [0.72 0.92 0.10 0.04], 'HorizontalAlignment','left');
            app.FsLabel = uicontrol(app.UIFig, 'Style','text', 'String','---', ...
                'Units', 'normalized', 'Position', [0.83 0.92 0.08 0.04], ...
                'BackgroundColor','white', 'HorizontalAlignment','left');

            % --- Axes (above footer, below toolbar) ---
            app.AxStim = axes(app.UIFig, 'Units', 'normalized', 'Position', [0.08 0.52 0.84 0.36]);
            app.AxLDF  = axes(app.UIFig, 'Units', 'normalized', 'Position', [0.08 0.08 0.84 0.40]);
        end
