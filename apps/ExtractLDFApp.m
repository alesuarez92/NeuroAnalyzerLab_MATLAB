    ...
    methods
        ...
        function buildUI(app)
            ...
            mainGrid = uigridlayout(app.UIFig, [5, 1], ...
                'RowHeight', {T.headerHeight, 44, 28, '1x', 22}, ...
                'ColumnWidth', {'1x'}, 'Padding', [0 0 14 14], 'RowSpacing', 10);
            ...
            % --- Toolbar: load, range, crop, save, Fs ---
            ...
            % --- Axes panel: Stimulus and LDF plots ---
            ...
            axGrid = uigridlayout(axPanel, [2, 1], 'RowHeight', {'1x', '1x'}, 'Padding', [10 10 10 10]);
